...
export default {
  ...
  coal: baseColorCoal,
  lightCoal: baseColorLightCoal,
  lighterCoal: baseColorLighterCoal,
  strongLighterCoal: baseColorStrongLighterCoal,
  loaderWhite: baseColorLoaderWhite,
  gray: baseColorGray,
  red: baseColorRed,
  beige: baseColorBeige,
